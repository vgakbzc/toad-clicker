(function (global, factory) {
        ...
        _createClass(LRUCache, [
            ...
            },
            {
                ...
                value: function set(key, value) {
                    ...
                    if (this.map.has(key)) {
                        throw new Error(
                            "Cannot update existing keys in the cache",
                        );
                    }
    ...
    var critical_tetr_values = [
        [
            ...
            1,
            1.0891180521811202527, 1.1789767925673958433, 1.2701455431742086633,
        ...
        [
            ...
            3.9191964192627283911, 5.135152840833186423, 6.9899611795347148455,
            10,
        ],
    ];
        ...
        for (var i = 0; i < 100; ++i) {
            ...
            wn = w.sub(
                wewz.div(
                    w
                        .add(1)
                        .sub(w.add(2).mul(wewz).div(Decimal.mul(2, w).add(2))),
                ),
            );
    ...
    var Decimal = /*#__PURE__*/ (function () {
        ...
        */
                ...
                },
                {
                    ...
                    value: function fromComponents_noNormalize(
                        sign,
                        layer,
                        mag,
                    ) {
                ...
                },
                {
                    ...
                    value: function fromString(value) {
                        ...
                        if (!isFinite(mantissa)) {
                            ...
                            this.mag =
                                exponent + Math.log10(Math.abs(mantissa));
                ...
                },
                {
                    ...
                    value: function add(value) {
                        ...
                        if (
                            (this.eq(Decimal.dInf) &&
                                decimal.eq(Decimal.dNegInf)) ||
                            (this.eq(Decimal.dNegInf) &&
                                decimal.eq(Decimal.dInf))
                        ) {
                        ...
                        if (layera === 0 && layerb === -1) {
                            if (
                                ...
                                var magdiff = Math.pow(
                                    10,
                                    Math.log10(a.mag) - b.mag,
                                );
                ...
                },
                {
                    ...
                    value: function mul(value) {
                        ...
                        throw Error(
                            "Bad arguments to mul: " + this + ", " + value,
                        );
                    },
                    /**
                     * Multiplication: returns the product of 'this' and 'value'.
                ...
                },
                {
                    ...
                    value: function cmpabs(value) {
                        ...
                        var layerb =
                            decimal.mag > 0 ? decimal.layer : -decimal.layer;
                ...
                },
                {
                    ...
                    value: function lt_tolerance(value, tolerance) {
                        var decimal = D(value);
                        return (
                            !this.eq_tolerance(decimal, tolerance) &&
                            this.lt(decimal)
                        );
                    },
                    /**
                    ...
                    value: function exp() {
                        ...
                        if (this.layer === 0 && this.mag <= 709.7) {
                            ...
                            return FC(
                                ...
                                2,
                                this.sign *
                                    (Math.log10(0.4342944819032518) + this.mag),
                            );
                        } else {
                ...
                },
                {
                    ...
                    value: function tetrate() {
                        ...
                        for (var _i = 0; _i < height; ++_i) {
                            ...
                            if (
                                !isFinite(payload.layer) ||
                                !isFinite(payload.mag)
                            ) {
                ...
                },
                {
                    ...
                    value: function slog() {
                        ...
                        for (var i = 1; i < iterations; ++i) {
                            ...
                            step_size =
                                Math.abs(step_size) * (currently_rose ? -1 : 1);
                            result += step_size;
                ...
                },
                {
                    ...
                    value: function layeradd(diff, base) {
                        ...
                        if (baseD.gt(1) && baseD.lte(1.44466786100976613366)) {
                            var excessSlog = Decimal.excess_slog(
                                this,
                                base,
                                linear,
                            );
                            ...
                            return Decimal.tetrate(
                                ...
                                towertop,
                                linear,
                            ); //wholediff is a whole number so this is safe even if it ends up calling iteratedlog
                        }
                        ...
                        function lambertw() {
                            ...
                            if (this.lt(-0.3678794411710499)) {
                                ...
                                if (this.abs().lt("1e-300"))
                                    ...
                                    return Decimal.fromNumber(
                                        f_lambertw(this.toNumber()),
                                    );
                                } else if (this.layer === 0) {
                                    return Decimal.fromNumber(
                                        f_lambertw(this.sign * this.mag),
                                    );
                ...
                },
                {
                    ...
                    value: function linear_sroot(degree) {
                        ...
                        if (degree > -2 && degree < -1) {
                            return Decimal.fromNumber(degree)
                                .add(2)
                                .pow(this.recip());
                        ...
                        if (this.gt(1)) {
                            ...
                            if (
                                this.gte(Decimal.tetrate(10, degree, 1, true))
                            ) {
                                upperBound = this.iteratedlog(
                                    10,
                                    degree - 1,
                                    true,
                                );
                                    ...
                                    if (
                                        ...
                                        while (
                                            ...
                                            prevPoint = _upper
                                                ...
                                                .recip();
                                            distance =
                                                _upperBound.sub(prevPoint);
                                            nextPoint =
                                                _upperBound.add(distance);
                                        }
                        ...
                        function pentate() {
                            ...
                            if (height > 0) {
                                ...
                                for (var _i2 = 0; _i2 < -height; ++_i2) {
                                    prevpayload = payload;
                                    payload = payload.slog(
                                        this,
                                        undefined,
                                        linear,
                                    ); // End early if it's settled on a limit

                                    if (payload.eq(prevpayload))
                                        return payload.normalize(); //bail if we're NaN
                ...
                },
                {
                    ...
                    value: function penta_log() {
                        ...
                        if (this.lt(-1)) {
                            ...
                            var limitcheck = base.tetrate(
                                this.toNumber(),
                                1,
                                linear,
                            );
                            if (this.eq(limitcheck))
                                return new Decimal(Decimal.dNegInf);
                            if (this.gt(limitcheck))
                                return new Decimal(Decimal.dNaN);
        ...
        Therefore, penta_root and sroot will return the same value. */
                ...
                },
                {
                    ...
                    value: function acos() {
                        if (this.mag < 0) {
                            return Decimal.fromNumber(
                                Math.acos(this.toNumber()),
                            );
                        }

                        if (this.layer === 0) {
                            return Decimal.fromNumber(
                                Math.acos(this.sign * this.mag),
                            );
                        }
                ...
                },
                {
                    ...
                    value: function atan() {
                        ...
                        if (this.layer === 0) {
                            return Decimal.fromNumber(
                                Math.atan(this.sign * this.mag),
                            );
                        }

                        return Decimal.fromNumber(
                            Math.atan(this.sign * 1.8e308),
                        );
                    },
                    /**
            ...
            [
                ...
                },
                {
                    key: "fromMantissaExponent",
                    value: function fromMantissaExponent(mantissa, exponent) {
                        return new Decimal().fromMantissaExponent(
                            mantissa,
                            exponent,
                        );
                    },
                ...
                {
                    key: "notEquals_tolerance",
                    value: function notEquals_tolerance(
                        value,
                        other,
                        tolerance,
                    ) {
                ...
                },
                {
                    ...
                    value: function efficiencyOfPurchase(
                        cost,
                        currentRpS,
                        deltaRpS,
                    ) {
                ...
                },
                {
                    ...
                    value: function randomDecimalForTesting(maxLayers) {
                        ...
                        var randomexp =
                            layer === 0
                                ? Math.random() * 616 - 308
                                : Math.random() * 16; //10% of the time, make it a simple power of 10
                ...
                },
                {
                    ...
                    value: function affordGeometricSeries_core(
                        ...
                        var actualStart = priceStart.mul(
                ...
                },
                {
                    ...
                    value: function affordArithmeticSeries_core(
                        ...
                        var actualStart = priceStart.add(
                            currentOwned.mul(priceAdd),
                        );
                        ...
                        return b
                            ...
                            .add(
                                b2
                                    .add(
                                        priceAdd.mul(resourcesAvailable).mul(2),
                                    )
                                    .sqrt(),
                            )
                            .div(priceAdd)
                        ...
                        for (var i = 0; i < critical_headers.length; ++i) {
                            if (critical_headers[i] == base) {
                                ...
                                var basefrac =
                                    ...
                                    (critical_headers[i + 1] -
                                        critical_headers[i]);
                                lower =
                                    grid[i][Math.floor(height)] *
                                        (1 - basefrac) +
                                    grid[i + 1][Math.floor(height)] * basefrac;
                                upper =
                                    grid[i][Math.ceil(height)] *
                                        (1 - basefrac) +
                ...
                },
                {
                    ...
                    value: function excess_slog(value, base) {
                        ...
                        if (value.lt(lower))
                            return [value.slog(base, 100, linear), 0];
                        if (value.eq(lower))
                            return [new Decimal(Decimal.dInf), 0];
                        if (value.eq(upper))
                            return [new Decimal(Decimal.dNegInf), 2];

                        if (value.gt(upper)) {
                            var slogzero = upper.mul(2);
                            var slogone = baseD.pow(slogzero);
                            var estimate = 0;
                            if (value.gte(slogzero) && value.lt(slogone))
                                estimate = 0;
                            ...
                            while (step_size > 1e-16) {
                                ...
                                towertop = slogzero
                                    .pow(1 - tested)
                                    .mul(slogone.pow(tested)); //Weighted geometric average

                                guess = Decimal.iteratedexp(
                                    base,
                                    estimate,
                                    towertop,
                                );
                                ...
                                else if (guess.lt(value))
                                    fracheight += step_size;
                                step_size /= 2;
                            }
                        ...
                        if (value.lt(upper) && value.gt(lower)) {
                            ...
                            var _estimate = 0;
                            if (value.lte(_slogzero) && value.gt(_slogone))
                                _estimate = 0;
                            ...
                            while (_step_size > 1e-16) {
                                ...
                                if (_guess2.eq(value))
                                    return [
                                        new Decimal(_estimate + _tested),
                                        1,
                                    ];
                                else if (_guess2.gt(value))
                                    _fracheight += _step_size;
                                _step_size /= 2;
                            }
                    ...
                    value: function increasingInverse(func) {
                        ...
                        return function (value) {
                            ...
                            if (currentCheck) {
                                ...
                                if (maxX.lt(FIRST_NEG_LAYER))
                                    currentCheck = true;
                                else if (minX.gt(FIRST_NEG_LAYER))
                                    currentCheck = false;
                                else {
                                    var _valCheck = func(
                                        new Decimal(FIRST_NEG_LAYER),
                                    );
                                ...
                                if (currentCheck) {
                                    ...
                                    var limit = Decimal.pow(
                                        10,
                                        EXP_LIMIT,
                                    ).recip();
                                    if (maxX.lt(limit)) currentCheck = false;
                                    else if (minX.gt(limit))
                                        currentCheck = true;
                                    else {
                                        var _valCheck2 = func(
                                            new Decimal(limit),
                                    ...
                                    if (currentCheck)
                                        rangeApply = function rangeApply(
                                            value,
                                        ) {
                                            return Decimal.pow(
                                                10,
                                    ...
                                    else if (minX.gt(EXP_LIMIT))
                                        currentCheck = false;
                                    else {
                                        var _valCheck4 = func(
                                            new Decimal(EXP_LIMIT),
                                        );
                                ...
                                if (currentCheck) {
                                    ...
                                    var _limit4 = Decimal.pow(10, EXP_LIMIT)
                                        .recip()
                                        .neg();

                                    if (maxX.lt(_limit4)) currentCheck = true;
                                    else if (minX.gt(_limit4))
                                        currentCheck = false;
                                    else {
                                        var _valCheck8 = func(
                                            new Decimal(_limit4),
                                    ...
                                    if (maxX.lt(-EXP_LIMIT))
                                        currentCheck = false;
                                    else if (minX.gt(-EXP_LIMIT))
                                        currentCheck = true;
                                    else {
                                        var _valCheck10 = func(
                                            new Decimal(-EXP_LIMIT),
                                        );
                                    ...
                                    if (currentCheck)
                                        ...
                                        if (maxX.lt(_limit6))
                                            currentCheck = false;
                                        else if (minX.gt(_limit6))
                                            currentCheck = true;
                                        else {
                                            var _valCheck11 = func(
                                                new Decimal(_limit6),
                                            );

                                            currentCheck =
                                                value.gt(_valCheck11);
                                            if (decreasing)
                                                currentCheck = !currentCheck;
                                        ...
                                        if (currentCheck)
                                            ...
                                            if (maxX.lt(_limit7))
                                                currentCheck = false;
                                            else if (minX.gt(_limit7))
                                                currentCheck = true;
                                            else {
                                                var _valCheck12 = func(
                                                    new Decimal(_limit7),
                                                );

                                                currentCheck =
                                                    value.gt(_valCheck12);
                                                if (decreasing)
                                                    currentCheck =
                                                        !currentCheck;
                            ...
                            var searchIncreasing =
                                (positive != reciprocal) != decreasing;
                            ...
                            for (var i = 1; i < iterations; ++i) {
                                ...
                                var currently_rose = comparative(
                                    new_decimal,
                                    value,
                                );
